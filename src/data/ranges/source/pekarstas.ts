// =============================================================================
// VENDORED REAL RANGE DATA — provider "pekarstas" (GGPoker chart pack).
// Source: https://github.com/AHTOOOXA/poker-charts  (MIT License)
//   Copyright (c) 2025-2026 Anton Safonov
// This is REAL community preflop strategy data (not fabricated). It is converted
// into our RangeNode schema at load time by ../convert.ts — see that file.
//
// Cell encoding (from the source project):
//   'fold' | 'call' | 'raise' | 'allin'   — a pure action (100%)
//   ['raise','fold'] etc.                 — a legacy 50/50 mix
//   unlisted hands                        — fold
// Action meaning is contextual to the scenario (raise = open/3bet/4bet; allin = jam/5bet).
// =============================================================================
